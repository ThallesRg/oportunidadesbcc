...
@section('content')
  <div class="account-layout border">
    ...
    <div class="account-bdy p-3">
      <p class="text-primary mb-4">Preencha todos os campos para criar uma vaga</p>
      <div class="row mb-3">
        <div class="col-sm-12 col-md-12">
          <form action="{{route('post.store')}}" id="postForm" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" placeholder="Titulo da vaga" class="form-control @error('job_title') is-invalid @enderror" name="job_title" value="{{ old('job_title') }}" required autofocus >
              @error('job_title')
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" placeholder="https://www.meusite.com/vaga" class="form-control @error('link') is-invalid @enderror" name="link" value="{{ old('link') }}" required autofocus >
                  @error('link')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
            ...
            <div class="form-group">
              ...
              <input type="text" placeholder="Localização" class="form-control @error('job_location') is-invalid @enderror" name="job_location" value="{{ old('job_location') }}" required >
              @error('job_location')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input type="text" placeholder="ex: 2000 - 5000" class="form-control @error('salary') is-invalid @enderror" name="salary" value="{{ old('salary') }}" required >
                  @error('salary')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
            ...
            <div class="form-group">
              ...
              <input type="text" placeholder="Habilidade1,Habilidade2 etc" class="form-control @error('skills') is-invalid @enderror" name="skills" value="{{ old('skills') }}" required >
            </div>
            ...
            <button type="button" id="postBtn" class="btn primary-btn">Criar vaga</button>
