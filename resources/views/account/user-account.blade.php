                ...
                <div class="row m-l-0 m-r-0">
                    ...
                    <div class="col-sm-8">
                        <div class="card-block">
                            <h6 class="m-b-20 p-b-5 b-b-default f-w-600">Informação</h6>
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <h6 class="text-muted f-w-400">Não definida</h6>
                                </div>
                            </div>
                            <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600">Conta</h6>
                            <div class="row">
                                <div class="col-sm-6">
                                    <p class="m-b-10 f-w-600">Senha</p>
                                    <a href="{{route('account.changePassword')}}" class="btn primary-outline-btn">Trocar senha</a>
                                </div>
                                <div class="col-sm-6">
                                  <p class="m-b-10 f-w-600">Sair</p>
                                    <a href="{{route('logout')}}" class="btn btn-outline-dark">Sair</a>
                                </div>
                            </div>
