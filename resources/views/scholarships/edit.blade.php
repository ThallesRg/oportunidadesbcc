                    ...
                    <form action="{{route('scholarships.update',['scholarship'=>$scholarship])}}" id="postForm" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Nome da bolsa de estudo"
                                ...
                                value="{{ old('name', $scholarship->name) }}" required autofocus>
                            @error('name')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control @error('end_date') is-invalid @enderror"
                                        name="end_date" value="{{ old('end_date', $scholarship->end_date) }}" required>
                                    @error('end_date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Valor da bolsa de estudo"
                                ...
                                value="{{ old('value', $scholarship->value) }}" required>
                            @error('value')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
