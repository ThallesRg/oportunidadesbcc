...
@section('content')
    <div class="account-layout border">
        ...
        <div class="account-bdy p-3">
            <p class="text-primary mb-4">Preencha todos os campos para criar um intercâmbio</p>
            <div class="row mb-3">
                <div class="col-sm-12 col-md-12">
                    <form action="{{ route('intercambios.store') }}" id="postForm" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" placeholder="Descrição do intercâmbio" wrap="soft"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="date" placeholder="Data de início"
                                        ...
                                        value="{{ old('registration_period_start_date') }}" required>
                                ...
                                <div class="col-md-6">
                                    <input type="date" placeholder="Data de término"
                                        ...
                                        value="{{ old('registration_period_end_date') }}" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="date" placeholder="Data de início"
                                        ...
                                        name="exchange_period_start_date" value="{{ old('exchange_period_start_date') }}"
                                        required>
                                ...
                                <div class="col-md-6">
                                    <input type="date" placeholder="Data de término"
                                        ...
                                        name="exchange_period_end_date" value="{{ old('exchange_period_end_date') }}"
                                        required>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-block">Criar intercâmbio</button>
                        </div>
                    </form>
                </div>
            </div>
