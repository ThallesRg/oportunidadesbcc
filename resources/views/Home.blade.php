          ...
          <div class="col-sm-12 col-md-6">
            <div class="px-4">
              ...
              <div class="home-search-bar">
                  <input type="text" name="q" placeholder="Busque Vagas Por Título" class="home-search-input form-control">
          ...
          <div class="col-sm-12 col-md-6">
            <div class="py-5 px-5 text-center">
              <div class="text-light">
                <h4>"Educação é a arma mais poderosa que você pode usar para mudar o mundo" </br> ~ Nelson Mandela
              </h4>
              </div>
            </div>
            </div>
